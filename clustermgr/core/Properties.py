...
# Note: modified by mbaser to fit needs of clustermgr
...
class Properties(object):
    ...
    def load(self, stream):
        ...
        # commented to enable reading from StringIO - mbaser
    ...
    def store(self, out, header=""):
        ...
        # commented to enable writing to StringIO - mbaser
        #if out.mode[0] != 'w':
        ...
        try:
            ...
            # No need to close StringIO - mbaser
            #out.close()
        except IOError, e:
            raise
